...
func MakeErrorLogMiddleware(logger log.Logger) Middleware {
...
func MakeTracingConsumerMiddleware(tracer opentracing.Tracer, opName string) Middleware {
	return func(h Handler) Handler {
		return HandleFunc(func(ctx context.Context, msg kafka.Message) error {
...
func MakeTracingProducerMiddleware(tracer opentracing.Tracer, opName string) Middleware {
	return func(h Handler) Handler {
		return HandleFunc(func(ctx context.Context, msg kafka.Message) error {
